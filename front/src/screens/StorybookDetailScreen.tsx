...
const StorybookDetailScreen = ({ route, navigation }: { route: StorybookDetailScreenRouteProp, navigation: any }) => {
    ...
    const openActionSheet = () => {
        ...
        if (!isAuthor) {
            Alert.alert('❌ 권한 없음', '작성자만 게시글을 수정하거나 삭제할 수 있습니다.');
            return;
        }
    ...
    const handleToggleLike = async () => {
        ...
        try {
            ...
            if (response) {  // ✅ response가 존재하는지 체크
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        >
                            ...
                            <View style={styles.authorContainer}>
                                ...
                                />
                                <View>
                                    <Text style={styles.authorName}>{selectedBoard.author?.nickname || '알 수 없음'}</Text>
                                    <Text style={styles.postDate}>{formatDate(selectedBoard.writeDatetime)}</Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.bottomBar}>
                                ...
                                <TouchableOpacity style={styles.bottomIcon}>
                                    ...
                                    <Text style={styles.bottomText}>{selectedBoard.commentCount || 0}</Text>
                                </TouchableOpacity>
                            </View>
