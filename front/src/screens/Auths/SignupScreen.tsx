...
const SignupScreen: React.FC<Props> = ({ navigation }) => {
    ...
    const getProfileImage = () => {
        return profileImage ? { uri: profileImage.uri } : require('../../assets/images/user-2.png');
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.subtitle}>Fill your information below or register with your social media account.</Text>
            ...
            <View style={styles.passwordContainer}>
                <TextInput placeholder="Password" secureTextEntry={!showPassword} style={styles.passwordInput} value={password} onChangeText={setPassword} />
